      ...
      body: ListView(
        ...
        children: [
            ...
            children: [
              ...
              Expanded(
                child: ArtButtonsKh(
                  ...
                  text: "Button",
                  backgroundColor: color,
                  customizeBorderRadius: const BorderRadius.only(topRight: Radius.circular(10), bottomRight: Radius.circular(10), ),
                ),
              ),
            ],
          ),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Expanded(child: ArtButtonsKh(onPressed: () {}, text: "Button", backgroundColor: color,                   prefixesIcons: Icon(Icons.add),
              )),
              const SizedBox(
                width: 10,
              ),
            ...
            children: [
              ...
              Expanded(
                child: ArtButtonsKh(
                  ...
                  backgroundColor: color,
                  fontSize: 10,
                  suffixesIcons: Icon(Icons.add, size: 20,),
                  prefixesIcons: Icon(Icons.add, size: 25,),                ),
              ),
            ],
          ),
        ],
