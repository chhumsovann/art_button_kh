            ...
            child: (isOutlineButton ?? false)
                ? GestureDetector(
                    ...
                    child: Material(
                      ...
                      child: Container(
                        decoration: BoxDecoration(shape: BoxShape.circle, border: Border.all(color: backgroundColor ?? Colors.red, width: lineSize ?? 1)),
                        child: circleIcon,
                      ),
                    ),
                  )
                    ...
                    style: ButtonStyle(
                      ...
                      shape: MaterialStateProperty.all(
                        RoundedRectangleBorder(
                          borderRadius: customizeBorderRadius == null ? BorderRadius.circular(radius ?? 8) : customizeBorderRadius ?? BorderRadius.circular(0),
                        ),
                      ),
